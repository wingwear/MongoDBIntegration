...
namespace MongoIntegrationFull.Activities
{
	...
	public abstract class AsyncTaskCodeActivity<T> : AsyncCodeActivity, IDisposable
	{
		...
		protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
		{
			...
			var task = ExecuteAsync(context, _cancellationTokenSource.Token, (servicesApplication ?? new MongoProperty()) as MongoProperty);
	...
	/// <summary>
	///     MongoIntegrationFull AsyncTaskCodeActivity without result
	/// </summary>
	public abstract class AsyncTaskCodeActivity : AsyncCodeActivity, IDisposable
	{
		...
		protected abstract Task<Action<AsyncCodeActivityContext>> ExecuteAsync(AsyncCodeActivityContext context, CancellationToken cancellationToken, MongoProperty client);
